    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == RC_SIGN_IN) {
            ...
            try {
                ...
                Toast.makeText(this, "Google Sign In successful, authenticate with Firebase done", Toast.LENGTH_SHORT).show();
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(MainActivity.this, "User Firebase authentication successful", Toast.LENGTH_SHORT).show();


                            Intent intent = new Intent(context, iNVV.class);
